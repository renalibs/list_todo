...
def create_config_file():
    if not os.path.exists( "./data" ):
        os.makedirs( "./data" )
    with open( "./data/list_todo.cfg" , 'w' , encoding = 'utf-8' ) as wFile:
        wFile.write( """[base]
root=./
...
def main():
    ...
    if ( not os.path.exists( "./data/list_todo.cfg" ) ):
        create_config_file()
    ...
    for dir in check_target_dirs:
        ...
        for file in files:
            ...
            if plans_count != 0:
                ...
                for plan in plans:
                    print( f"   * \033[0;32m{ plan.msg }\033[0m (v{ plan.version }) (Ln { plan.start_line }, Col { plan.start_col })" )
